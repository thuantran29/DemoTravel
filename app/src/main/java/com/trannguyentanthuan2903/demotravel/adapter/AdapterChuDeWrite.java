...
import com.trannguyentanthuan2903.demotravel.activity.WriteShareActivity;
...
public class AdapterChuDeWrite extends BaseAdapter{
    private Context context;
    private int layout;
    ArrayList<ChuDeDTO> arrayChuDe;

    public AdapterChuDeWrite(Context context, int layout, ArrayList<ChuDeDTO> arrayChuDe) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                WriteShareActivity.txTenChuDeWrite.setText(sp.TenChuDe);
                Glide.with(context).load(sp.Hinh).into(WriteShareActivity.imgHinhChuDeWrite);
                WriteShareActivity.bottomSheetDialog.dismiss();
            }
        });
        return rowView;

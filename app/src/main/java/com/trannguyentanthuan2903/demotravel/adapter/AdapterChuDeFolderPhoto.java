...
import com.trannguyentanthuan2903.demotravel.activity.FolderPhotoActivity;
...
public class AdapterChuDeFolderPhoto extends BaseAdapter {
    private Context context;
    private int layout;
    ArrayList<ChuDeDTO> arrayChuDe;

    public AdapterChuDeFolderPhoto(Context context, int layout, ArrayList<ChuDeDTO> arrayChuDe) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.cb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                FolderPhotoActivity.txTenChuDeFolder.setText(sp.TenChuDe);
                Glide.with(context).load(sp.Hinh).into(FolderPhotoActivity.imgHinhChuDeFolder);
                FolderPhotoActivity.bottomSheetDialog.dismiss();
            }
        });
        return rowView;
